...
python3 src\PixelByPixelCompareWeighted .\Intermediate\indexed.png .\Result\AccuracyTest.png
...
python3 src\PixelByPixelCompareWeighted .\Intermediate\indexed.png .\Result\output.png


ECHO Robot Arm Wrapping Output test (compare image drawn by robot arm with wrapping method with original indexed image)

python3 src\PixelByPixelCompareWeighted .\Intermediate\indexed_masked.png .\Result\OutputRT_CropScaled_masked.png
...
python3 src\PixelByPixelCompareWeighted .\Intermediate\indexed_masked.png .\UnrealOutput\OutputWrap9_CropScaled_masked.png
